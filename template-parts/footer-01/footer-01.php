...
<footer class="w-full py-10 px-6 md:px-16 lg:px-32 bg-[#13141a] flex flex-col md:flex-row items-center justify-between">
  <div class="flex items-center space-x-3 mb-4 md:mb-0">
    <img src="<?php echo esc_url(is_array($footer_logo) && isset($footer_logo['url']) ? $footer_logo['url'] : $footer_logo); ?>" alt="<?php echo esc_attr($footer_site_title); ?> Logo" class="w-8 h-8 rounded-full" loading="lazy" />
